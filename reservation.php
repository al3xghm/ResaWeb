...
<body>
    ...
    <div id="recapitulatif" style="display:none; margin-top: 2rem;">
        <div class="apercu">
            <div class="apercu-reservation">
                ...
                <div class="btn-reservation">
                    <button onclick="editReservation()">Retour à la réservation</button>
        ...
        <p class="reservation-warning">🚨 Attention, votre réservation ne sera pas confirmée tant que vous n'aurez pas reçu un email de
